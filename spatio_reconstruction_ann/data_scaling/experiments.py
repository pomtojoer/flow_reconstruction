...
def experiment_2(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['data_scaling_parameters']['scaling_method'] = 'standardise'
    # ---------------------------------------------------------------
...
def experiment_3(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['data_scaling_parameters']['scaling_method'] = 'normalise'
    # ---------------------------------------------------------------
...
def experiment_4(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['data_scaling_parameters']['scaling_method'] = 'unscaled'
    # ---------------------------------------------------------------
