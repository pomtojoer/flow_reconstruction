# ---------------------- changed this ----------------------
from multiple_reconstruction_8.base import experiment
# ----------------------------------------------------------
...
def experiment_1(train_model=False):
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_1_t4_1'
    # ----------------------------------------------------------
    ...
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_1_t4_2'
    # ----------------------------------------------------------
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 16
    # ---------------------------------------------------------------
    ...
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_1_t4_3'
    # ----------------------------------------------------------
...
def experiment_2(train_model=False):
    # P3 instance
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_2_v100_1'
    # ----------------------------------------------------------
    ...
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_2_v100_2'
    # ----------------------------------------------------------
    ...
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_2_v100_3'
    # ----------------------------------------------------------
...
def experiment_3(train_model=False):
    # P4 instance
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_3_a100_1'
    # ----------------------------------------------------------
    ...
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_3_a100_2'
    # ----------------------------------------------------------
    ...
    # ---------------------- changed this ----------------------
    save_folder_name = 'experiment_3_a100_3'
    # ----------------------------------------------------------
