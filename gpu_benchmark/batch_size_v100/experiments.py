# ---------------------- changed this ----------------------
from batch_size_v100.base import experiment
# ----------------------------------------------------------
...
def experiment_1(train_model=False):
    ...
    data['training_parameters']['batch_size'] = 32
    # ---------------------------------------------------------------
...
def experiment_2(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 8
    data['training_parameters']['batch_size'] = 64
    # ---------------------------------------------------------------
...
def experiment_3(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 8
    data['training_parameters']['batch_size'] = 128
    # ---------------------------------------------------------------
...
def experiment_4(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 8
    data['training_parameters']['batch_size'] = 256
    # ---------------------------------------------------------------
...
def experiment_5(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 8
    data['training_parameters']['batch_size'] = 512
    # ---------------------------------------------------------------
...
def experiment_6(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 8
    data['training_parameters']['batch_size'] = 1024
    # ---------------------------------------------------------------
...
def experiment_7(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 8
    data['training_parameters']['batch_size'] = 2048
    # ---------------------------------------------------------------
