# ---------------------- changed this ----------------------
from resolution_reduction_expanded_dataset.base import experiment
# ----------------------------------------------------------
...
def experiment_1(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 1
    # ---------------------------------------------------------------
...
def experiment_2(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 2
    # ---------------------------------------------------------------
...
def experiment_3(train_model=False):
    ...
    # ---------------------- changed parameter ----------------------
    data['sensor_parameters']['down_res'] = 4
    # ---------------------------------------------------------------
